const scrappingKeysAndElements = {
  Name: '[class="D(ib) Fz(18px)"]',
  ...
  PriceEarningRatio: '[data-test="PE_RATIO-value"]',
  EarningPerShare: '[data-test="EPS_RATIO-value"]',
  EarningsDate: '[data-test="EARNINGS_DATE-value"]',
  ForwardDividendAndYield: '[data-test="EARNINGS_DATE-value"]',
  ExDividendDate: '[data-test="EX_DIVIDEND_DATE-value"]',
  OneYearTargetEstimation: '[data-test="ONE_YEAR_TARGET_PRICE-value"]',
};

export default scrappingKeysAndElements;
